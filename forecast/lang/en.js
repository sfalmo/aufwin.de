...
var dict = {
    ...
    "isUnknownValid": "Validity could not be determined. Data is probably missing.",
    "validityUnknown": "Validity info not found",
    "from": "from",
    ...
    "zwblmaxmin.longname": "Height of Collective Up/Down Motion",
    "zwblmaxmin.description": "Height above sea level of the values shown in Collective Up/Down Motion (Convergence/Divergence).",
    ...
    "zsfclclmask.description": "Combining Cumulus Cloudbase and Cumulus Potential, a mask is calculated and the cumulus cloudbase is only shown where its potential is greater than 0.",
    ...
    "zblclmask.description": "Combining Overdevelopment Cloudbase and Overdevelopment Potential, a mask is calculated and the overdevelopment cloudbase is only shown where its potential is greater than 0.",
