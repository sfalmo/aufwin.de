...
var dict = {
    ...
    "isUnknownValid": "Validity could not be determined",
    "from": "from",
    ...
    "zsfclclmask.description": "Combining Cumulus Cloudbase and Cumulus Potential, a mask is calculated and the cumulus cloudbase is only shown where the cumulus potential is greater than 0.",
    "zblcldif.longname": "Overcast Potential",
    "zblcldif.description": "Potential for extensive cloud formation (overcast development) at the boundary layer top, i.e. the height difference between Boundary Layer Height and Overcast Cloudbase.",
    "zblcl.longname": "Overcast Cloudbase",
    "zblcl.description": "Cloudbase for extensive boundary layer clouds (overcast development). Unlike the Cumulus Cloudbase parameter, the boudary layer condensation level is used, which is based upon the average boundary layer humidity, and is therfore only relevant to extensive cloud formation.",
    "zblclmask.longname": "Overcast Cloudbase where Potential > 0",
    "zblclmask.description": "Combining Overcast Development Cloudbase and Overcast Development Potential, a mask is calculated and the overcast cloudbase is only shown where the overcast development potential is greater than 0.",
    ...
    "blcloudpct.longname": "Boundary Layer Cloud Cover",
    "blcloudpct.description": "Cloud cover due to clouds developing in the boundary layer.",
    "wrf=CFRACL.longname": "Cloud Fraction - Low",
    "wrf=CFRACL.description": "Cloud cover of low height clouds.",
    "wrf=CFRACM.longname": "Cloud Fraction - Mid",
    "wrf=CFRACM.description": "Cloud cover of mid height clouds.",
    "wrf=CFRACH.longname": "Cloud Fraction - High",
    "wrf=CFRACH.description": "Cloud cover of high clouds.",
    "rain1.longname": "Rain",
