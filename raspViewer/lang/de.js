...
var dict = {
    ...
    "isUnknownValid": "Gültigkeit der Daten konnte nicht bestimmt werden",
    "from": "aus",
    ...
    "wstar_bsratio.description": "Zusammengesetzter Plot aus Thermikstärke und Auftrieb-/Scher-Verhältnis. Bereiche mit geringem Auftrieb-/Scher-Verhältnis sind gepunktet dargestellt.",
    ...
    "zsfclcl.description": "Wolkenbasis für kompakte und alleinstehende (nicht ausbreitende) Quellbewölkung, berechnet durch das Liftig Condensation Level von erdoberflächennahen Luftmassen. Dies ist die Höhe, ab der ein vom Boden adiabatisch aufsteigendes und abkühlendes Luftpaket seinen Taupunkt erreicht und es zur Wolkenbildung durch Kondensation kommt.",
    "zsfclclmask.longname": "Cumulus-Wolkenbasis wo Potential > 0",
    "zsfclclmask.description": "Cumulus-Wolkenbasis nur dort dargestellt, wo Cumulus-Potential größer 0 ist.",
    "zblcldif.longname": "Stratocumulus-Potential",
    "zblcldif.description": "Potential für die Entwicklung ausbreitender Bewölkung an der Grenzschichtoberseite, berechnet durch die Differenz zwischen Grenzschichthöhe und Stratocumulus-Wolkenbasis.",
    "zblcl.longname": "Stratocumulus-Wolkenbasis",
    "zblcl.description": "Wolkenbasis für sich an der Grenzschichtoberseite ausbreitende Bewölkung (Stratocumulus). Im Gegensatz zur Cumulus-Wolkenbasis wird hier das sog. Boundary Layer Condensation Level genutzt, das auf der mittleren Luftfeuchtigkeit der Grenzschicht basiert.",
    "zblclmask.longname": "Stratocumulus-Wolkenbasis wo Potential > 0",
    "zblclmask.description": "Stratocumulus-Wolkenbasis nur dort dargestellt, wo Stratocumulus-Potential größer 0 ist.",
    ...
    "blcwbase.description": "",
    "blcloudpct.longname": "Grenzschichtbewölkung",
    "blcloudpct.description": "Bewölkungsgrad durch Wolken in der Grenzschicht.",
    "wrf=CFRACL.longname": "Bewölkungsgrad - Niedrige Wolken",
    "wrf=CFRACL.description": "Bewölkungsgrad für niedrige Wolken.",
    "wrf=CFRACM.longname": "Bewölkungsgrad - Mittlere Wolken",
    "wrf=CFRACM.description": "Bewölkungsgrad für Wolken in mittlerer Höhe.",
    "wrf=CFRACH.longname": "Bewölkungsgrad - Hohe Wolken",
    "wrf=CFRACH.description": "Bewölkungsgrad für hohe Wolken.",
